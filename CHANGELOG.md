...
## [v1.3.6](https://github.com/nubisproject/nubis-puppet-configuration/tree/v1.3.6) (2018-07-25)
[Full Changelog](https://github.com/nubisproject/nubis-puppet-configuration/compare/v1.0.0...v1.3.6)

**Closed issues:**

- Add more items to search and replace [\#63](https://github.com/nubisproject/nubis-puppet-configuration/issues/63)
- Silence error output for confd script [\#61](https://github.com/nubisproject/nubis-puppet-configuration/issues/61)
- Tag v1.3.5 release [\#56](https://github.com/nubisproject/nubis-puppet-configuration/issues/56)
...
- Add more convinience search and replace [\#64](https://github.com/nubisproject/nubis-puppet-configuration/pull/64) ([limed](https://github.com/limed))
- Fix search and replace code to only search and replace if userdata exists [\#62](https://github.com/nubisproject/nubis-puppet-configuration/pull/62) ([limed](https://github.com/limed))
- Update CHANGELOG for v1.3.5 release \[skip ci\] [\#58](https://github.com/nubisproject/nubis-puppet-configuration/pull/58) ([nubis-automation](https://github.com/nubis-automation))
- Update CHANGELOG for v1.3.5 release \[skip ci\] [\#57](https://github.com/nubisproject/nubis-puppet-configuration/pull/57) ([nubis-automation](https://github.com/nubis-automation))
